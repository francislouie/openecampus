...
class report_unpaid_fee_bills_2folded(report_sxw.rml_parse):
    
    """
    This is the paser called when 2 folded fee challans are to be printed, tested by shahid 29 DEC 17
    
    """
 
    def __init__(self, cr, uid, name, context):
 
        super(report_unpaid_fee_bills_2folded, self).__init__(cr, uid, name, context)
        self.result_temp=[]
...
report_sxw.report_sxw('report.smsfee_print_three_student_per_page', 'smsfee.classfees.register', 'addons/smsfee/smsfee_unpaid_receipts_report_3o1.rml',parser = report_unpaid_fee_bills_2folded, header=None)
