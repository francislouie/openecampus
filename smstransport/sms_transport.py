                        ...
                        for this_student in students_ids:
                            if this_student.transport_availed and this_student.state == 'Admitted':
                                ...
                                if ses_id.session_id.id==f.session_id.id:
                                    ...
                                    call = self.pool.get('smsfee.studentfee').insert_student_monthly_non_monthlyfee(cr, uid, this_student.id, this_student.current_class.id,ftrow.name.fee_type.id, ftrow, f.id)
                                else:
