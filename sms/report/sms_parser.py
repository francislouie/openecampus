    ...
    def get_result_sheet(self,form):
        ...
        if academiccalendar_id:
            ...
            my_dict1 = {'SNO':'S.No', 'reg_no':'Admission No','name':'Name','subject_1':'','subject_2':'','subject_3':'','subject_4':'','subject_5':'','subject_6':'',
                        'subject_7':'','subject_8':'','subject_9':'','subject_10':'','subject_11':'', 'marks':'Marks Obtained','total_marks':'Total Marks', 'percentage':'%age', 'position':'Position'}
            ...
            for subject_row in subject_rows:
                ...
                if subject_row[2]: 
                    ...
                    my_dict1['subject_' + str(count)] = str(subject_row[1]) + " (" + str(practical[1]) + ")" 
                count = count + 1
            result.append(my_dict1)
            ...
            for rec1 in students_acad_cal_rows:
                ...
                my_dict1 = {'SNO':'S.No', 'reg_no':'Admission No','name':'Name','subject_1':'','subject_2':'','subject_3':'','subject_4':'','subject_5':'','subject_6':'',
                            'subject_7':'','subject_8':'','subject_9':'','subject_10':'','subject_11':'', 'marks':'Marks Obtained','total_marks':'Total Marks', 'percentage':'%age', 'position':''}
