...
class sms_student_list(osv.osv_memory):
    ...
    _columns = {
              ...
              'list_type': fields.selection([('class_list','Class List'),('contact_list','Contact list'),('check_admissions','Check Admissions'),('biodata','Student Biodata')], 'List Type', required = True),
